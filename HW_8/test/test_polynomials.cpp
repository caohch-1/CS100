...
void doTest( const Poly<TYPE> & poly, TYPE param, TYPE expectation ) {
  ...
  //std::cout<<poly.eval(param)<<std::endl;
...
int main() {
  ...
  // std::vector<TYPE> for_test1{1,2,3,4,5};
  // Poly<TYPE> test1(for_test1);

  // std::vector<TYPE> for_test2{1,2,-3,4,-5};
  // Poly<TYPE> test2(for_test2);

  // Poly<TYPE> test3=test1+test2;
  // for(int i=0;i<test3.getCoeffs().size();i++){
  //   std::cout<<test3.getCoeffs()[i]<<std::endl;
